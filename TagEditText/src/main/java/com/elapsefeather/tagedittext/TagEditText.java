...
public class TagEditText extends AppCompatAutoCompleteTextView implements TextWatcher {
    ...
    private void init() {
        ...
        setThreshold(1);
        setDropDownVerticalOffset(TagUtils.convertDpToPixelSize(-8, getContext()));
            ...
            new Thread(() -> {
                ...
                new Handler(Looper.getMainLooper()).post(() -> {
                    try {
                        ...
                        if (popup != null) {
                            popup.setElevation(TagUtils.convertDpToPixel(24, getContext()));
                            ...
                            if (backgroundView != null) {
                                ...
                                backgroundView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                                    ...
                                    public void onGlobalLayout() {
                                        ...
                                        int dp16 = TagUtils.convertDpToPixelSize(16, getContext());
                                        int maxTop = TagUtils.getStatusBarHeightPixel(getContext()) + dp16;
                                        int height = backgroundView.getHeight();
                                        int top = point[1] - height - TagUtils.convertDpToPixelSize(8, getContext()) - params.topMargin;
    ...
    private final ViewOutlineProvider mRoundCornerOutlineProvider = new ViewOutlineProvider() {
        ...
        public void getOutline(View view, Outline outline) {
            outline.setRoundRect(0, 0, view.getWidth(), view.getHeight(),
                    TagUtils.convertDpToPixel(8, getContext()));
        }
    };
}
